...
BASE_DIR = PosixPath('/home/carmen/02/po/pol')  ###
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.sqlite3', 'NAME': PosixPath('/home/carmen/02/po/pol/db.sqlite3'), 'ATOMIC_REQUESTS': False, 'AUTOCOMMIT': True, 'CONN_MAX_AGE': 0, 'CONN_HEALTH_CHECKS': False, 'OPTIONS': {}, 'TIME_ZONE': None, 'USER': '', 'PASSWORD': '', 'HOST': '', 'PORT': '', 'TEST': {'CHARSET': None, 'COLLATION': None, 'MIGRATE': True, 'MIRROR': None, 'NAME': None}}}
DATABASE_ROUTERS = []
...
SECRET_KEY = 'django-insecure-lsy!n!sq2o7+%z8xxzi2rk^nndg1tp7mwjklljmsml2yi$7=9l'
